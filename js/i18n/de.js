    ...
    tabs: {
        ...
        collection: {
            ...
            filters: {
                ...
                iris: {
                    ...
                    info2: "Du kann Kartefiltern benutzen um diesen Nummern zu beeinflussen und Aktionen deduzieren zu nicht entdeckende Karten erhalten.",
                },
            }
        },
        marketplace: {
            ...
            strings: {
                ...
                ad_effects: {
                    ...
                    energy_time: "“Siehe” eine “Werbung” an und bekomme passiv Massen Energie {x0:1} schneller für {1s}!",
                },
        ...
        options: {
            ...
            items: {
                ...
                localSave: "Lokal Speicherung",
                cloudSave: "Cloud Speicherung",
                info: "Info",
            ...
            values: {
                ...
                items: {
                    ...
                    manualSave: "Manualle Speicherung",
                    importExport: "Import/Export Speicherung",
                    hardReset: "Feste Zurücksetzung",
                    checkSaves: "Speicherungen Checken",
                    about: "Über & Quelle",
            ...
            strings: {
                ...
                save_timer: "(letzt geschpeichert {0} vorher)",
                ...
                language_desc: "Sprachen außer Englisch sind vielliecht nicht 100% fertig oder richtig.",
                notation_desc: "Wie größe Nummer im Spiel ausgedruckt werden ändern. Die “Standard” Nummerform is von aktuellen Sprache basiert.",
                verb_desc: "Verb assoziiert mit {drawing} Karten ändern, in Plätzer wie das Spieltitel und Karte Beschreibungen.",
                john_note: "(Notiz: Links öffnen dieses Tab, ctrl+click um nicht ausversehendlich das Spiel schließen)",
            },
            popups: {
                confirm: {
    ...
    popups: {
        ...
        confirm: {
            sellAccount: {
                ...
                desc1: "Du will wiederstarten mit einer neues Konto, aber du wirdst <b>Geld</b> and <b>Erfahrungspunkte</b> basiert auf deiner Erfolgreichen.",
                desc2: "<strong>Da gibt kein Zurückkaufen</strong>—das Spiel will speichen wenn du deiner Konto verkaufst!",
                confirm: "Mich fragen nächstest mal ich meiner Konto verkaufe",

                list_lose: "Du wirdst verlieren:",
                list_lose1: "Dein normale Kartensammelung ",
                list_lose2: "Punkte, Schnipseln, und Faktion Power",
                list_lose3: "Fähigkeiten und Nutzungstatistik",

                list_gain: "Dur wirdst bekommen:",
        ...
        card: {
            ...
            strings: {
                ...
                level: "(level {0})",
                notOwned: "(karte nicht im betsitz)",

                level_title: "Upgrade",
                level_cost: "Upgrade Preis:",
                level_cant: "Dieser Karte kann nicht upgradet sin.",
                level_cant_max: "Maximum level erreicht.",
                level_cant_cost: "Nicht genug {0}.",
                level_prompt: "Clicken um upgraden.",
                level_button: "Upgrade",
                level_button_cant: "Kann nicht upgrade",
                level_button_max: "Maximum level erreicht",

                star_title: "Fusion",
                star_cost: "Fusion Preis:",
